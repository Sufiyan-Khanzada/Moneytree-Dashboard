...
<html lang="en" data-footer="true" data-override='{"attributes": {"placement": "vertical", "layout": "boxed" }, "storagePrefix": "ecommerce-platform"}'>
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Show Committee Details</h1>
                    </div>
                    <br>   
                </div>
 ...
 -->
        ...
        <!-- Discount List Start -->
                    ...
                    $sql = "SELECT * FROM committee_user where committee_num=$id";
                    ...
                    ?>
                     ...
                     <h2 style="font-family:Arial;"> Your <?php echo  "[".$row['id']."]  Committee Details"?></h2>
                     <hr>
...
<br>
  ...
  <div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control" readonly value="<?php  echo $row['committee_num']?>">
    </div>
    <div class="col">
        <label>Committee ID</label>
      <input type="text" class="form-control"  readonly value="<?php  echo $row['committe_id']?>">
    </div>
</div>
   <br>
<div class="row">
    <div class="col">
        <label>Time</label>
      <input type="text" class="form-control" readonly value="<?php  echo $row['time']?>">
    </div>
    <div class="col">
        <label>Committee Start Month</label>
      <input type="text" class="form-control"  readonly value="<?php  echo $row['committee_start_month']?>">
    </div>
</div>
<br>
   <div class="row">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control"  readonly value="<?php  echo $row['payment_no']?>">
    </div>
</div>
<br>
   <div class="row">
    <div class="col">
        <label>Status</label>
      <input type="text" class="form-control" readonly value="<?php  echo $row['payment_date']?>">
    </div>
    <div class="col">
        <label>Payement No</label>
