...
{
$noti_title=$_POST['title'];
$noti_mess=$_POST['message'];

$query="UPDATE notifications SET title='$noti_title',message='$noti_mess' WHERE id='$upd_id'";
$result_query=mysqli_query($conn,$query);

if($result_query){

    $msg="<div class='alert alert-success'>
  <strong>Success!</strong> Notification Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Notification Is not Update in Database
</div>";
 }
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Edit Notification</h1>
                    </div>
                </div>
                <!-- Title End -->
...
<br>
    ...
    <div class="col">
      ...
      <input type="textarea" class="form-control" name="message" colspan="2" value="<?php  echo $row['message']?>">
    </div>
