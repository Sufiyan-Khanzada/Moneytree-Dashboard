...
$query="UPDATE youtubelinks SET title='$video_title',link='$video_link',thumbnail='$target_file' WHERE ID='$upd_id'";

}
else{
$query="UPDATE youtubelinks SET title='$video_title',link='$video_link' WHERE ID='$upd_id'";
...
if($result_query){
  ...
  <strong>Success!</strong> Video Session Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Video Session Is not Update in Database
</div>";
 }
    ...
    <div id="root">
      ...
      <main>
        ...
        <!-- Discount List Start -->
                            <?php
$id=$_GET['id'];
                    $sql = "SELECT * FROM  youtubelinks where id=$id";
...
<br>
    ...
    <div class="col">
      ...
      <input type="file" class="form-control" id="file" name="file"  value="<?php  echo $row['id']?>">
    </div>
</div>
...
<div class="row">
        <div class="col text-center">
            <img src="<?php echo $row['thumbnail']; ?> " width=600 height=400>
    </div>
</div>
<br>
<br>
<div class="row">
        ...
        <a href="Dashboard.html">  <button   type="submit" value="Save" name="updatevid" class="btn  btn-icon btn-icon-end btn-primary">
                            <span>
