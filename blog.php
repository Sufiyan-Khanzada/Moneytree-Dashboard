                ...
                <div class="card mb-2 bg-transparent no-shadow d-none d-lg-block">
                    <div class="card-body pt-0 pb-0 sh-3">
                        <div class="row g-0 h-100 align-content-center">
                            ...
                            <div
                                class="col-4 col-lg-4 d-flex align-items-center text-alternate text-medium text-muted text-small">
                                Blog Short Description
                            </div>
                           
                            <div
                                class="col-4 col-lg-1 d-flex align-items-center text-alternate text-medium text-muted text-small" >
                           Actions
                            </div>
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="row g-0 h-100 align-content-center">
                                ...
                                <div
                                    class="col-11 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-1 order-lg-1 h-lg-100 position-relative">
                                    <a href="#" class="text-truncate h-100 d-flex align-items-center"
                                       data-bs-toggle="modal" ><?php echo $row['blog_title'];?></a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-2 order-lg-2">
                                    <div class="text-muted text-small d-lg-none"></div>
                                    <div class="text-alternate autoShowHide"><?php echo $row['blog_long_discript'];?></div>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-3">
                                    <div class="text-muted text-small d-lg-none"></div>
                                    <div class="text-alternate autoShowHide"><?php echo $row['blog_short_discript'];?></div>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-3 order-lg-3">
                                    <div class="text-muted text-small d-lg-none"></div>
                                    ...
                                    <?php  echo '<img src="'.$row['blog_image'].'" alt="HTML5 Icon" style="width:58px;height:58px">';?></div>
                                </div>
                                <div
                                    class="col-2 col-lg-1 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-4 order-lg-4">
                                    <a href='blog-edit.php?id=<?php echo $row['id']; ?>' class="text-truncate h-100 d-flex align-items-center"
                                ...
                                <div
                                    ...
                                    <a href='blogdelete.php?id=<?php echo $row['id']; ?>' class="text-truncate h-100 d-flex align-items-center"
