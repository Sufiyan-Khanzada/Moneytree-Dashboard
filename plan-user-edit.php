...
if($type!="Select Type"){
$query="UPDATE plan_user SET user_id='$userid',plan_id='$planid',type='$type',status='$status',amount='$amount' WHERE id='$upd_id'";
}
else{
$query="UPDATE plan_user SET user_id='$userid',plan_id='$planid',type='$old_type',status='$status',amount='$amount' WHERE id='$upd_id'";
    ...
    <div id="root">
      ...
      <main>
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Edit User Details</h1>
                    </div>
                </div>
                <!-- Title End -->
        ...
        <!-- Discount List Start -->
                            <?php
$id=$_GET['id'];
                    $sql = "SELECT * FROM plan_user where id=$id";
...
<br>
    ...
    <div class="col">
      ...
      <input type="text" class="form-control" name="pid"  readonly colspan="2" value="<?php  echo $row['plan_id']?>">
    </div>

    <div class="col">
        <label>Current Type</label>
      <input type="text" class="form-control" name="old_type" readonly  value="<?php  echo $row['type'];?>">
...
<div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control" name="status" colspan="2" value="<?php  echo $row['status']?>">
    </div>
