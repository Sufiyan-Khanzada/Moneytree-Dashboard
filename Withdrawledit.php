...
$query="UPDATE withdrawl_request SET status='$status' WHERE order_id='$order_id'";
$result_query=mysqli_query($conn,$query);

if($result_query){

    $msg="<div class='alert alert-success'>
  <strong>Success!</strong> Withdrawl Request Edit Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Withdrawl Request Is not Update in Database
</div>";
 }
    ...
    <div id="root">
      ...
      <main>
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Edit Withdrawl Request</h1>
                    </div>
                </div>
                <!-- Title End -->
        ...
        <!-- Discount List Start -->
                            <?php
              $order_id=$_GET['order_id'];
                    $sql = "SELECT * FROM withdrawl_request where order_id=$order_id";
