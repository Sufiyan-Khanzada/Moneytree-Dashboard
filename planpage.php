            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Plan Page</h1>
                    </div>
                </div>
                <!-- Title End -->
              ...
              <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                 <!-- Length Start -->
                    ...
                    Select Option
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-end">
                            <a class="dropdown-item active " href="#">Select Plan</a>
                            <a class="dropdown-item " href="#">3Months</a>
                            <a class="dropdown-item " href="#">6Months</a>
                            <a class="dropdown-item " href="#">1Year</a>
                            <a class="dropdown-item " href="#">3YearPlus</a>
                            <a class="dropdown-item " href="#">BC_6Months</a>
                 ...
                 <!-- Length Transcationtype Start -->
                    ...
                    >
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-end">
                            <a class="dropdown-item active " href="#">Select Type</a>
                ...
                <div class="card mb-2 bg-transparent no-shadow d-none d-lg-block">
                    <div class="card-body pt-0 pb-0 sh-3">
                        <div class="row g-0 h-100 align-content-center">
                            <div class="col-11 col-lg-1 d-flex align-items-center mb-2 mb-lg-0 text-muted text-small">
                            User_id
                            </div>
                        ...
                        <div class="card-body py-4 py-lg-0 sh-lg-8">
                            <div class="row g-0 h-100 align-content-center">
                                ...
                                <div
                                    ...
                                    <div class="text-muted text-small d-lg-none"></div>
                                    <a href="#" class="text-truncate h-100 d-flex align-items-center"
                                       data-bs-toggle="modal" ><?php echo $row['plan_name'];?></a>
                                </div>
                                <div
                                    class="col-6 col-lg-2 d-flex flex-column justify-content-center mb-2 mb-lg-0 order-1 order-lg-1 h-lg-100 position-relative">
                                    <div class="text-muted text-small d-lg-none"></div>
                                ...
                                <!-- <div
                                    ...
                                    <div class="text-alternate">
                                             ...
                                             <?php  echo '<img src="https://demo.code7labs.com/api/moneytree-backend/upload/'.$row['image'].'" alt="HTML5 Icon" style="width:58px;height:58px">';?></div>
        ...
        <div class="modal modal-right fade" id="discountAddModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="post-form" action="addwallet.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3 w-100">
