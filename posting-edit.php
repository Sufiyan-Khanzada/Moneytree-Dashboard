...
$date_pro=$_POST['date'];
$query="UPDATE plan_posting SET plan_id='$plan_id',date='$date_pro',plan_title='$plan_title', profit_percent='$profit_percent' WHERE id='$upd_id'";
$result_query=mysqli_query($conn,$query);

if($result_query){

    $msg="<div class='alert alert-success'>
  <strong>Success!</strong> Plan Posting Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Plan Posting Is not Update in Database
</div>";
 }
    ...
    <div id="root">
      ...
      <main>
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Edit Plan Posting</h1>
                    </div>
                </div>
                <!-- Title End -->
        ...
        <!-- Discount List Start -->
                            <?php
$id=$_GET['id'];
                    $sql = "SELECT * FROM plan_posting where id=$id";
  ...
  <div class="row">
    ...
    <div class="col">
        <label>Plan ID</label>
      <input type="text" class="form-control" name="plan_id" readonly value="<?php  echo $row['plan_id']?>">
    </div>
</div>
<br>
...
<div class="row">
    ...
    <div class="col">
        ...
        <input type="text" class="form-control" name="plan_title" colspan="2" value="<?php  echo $row['plan_title']."%"?>">
    </div>
</div>
<br>
    ...
    <div class="col">
      ...
      <input type="text" class="form-control" name="profit_percent" colspan="2" value="<?php  echo $row['profit_percent']."%"?>">
    </div>
