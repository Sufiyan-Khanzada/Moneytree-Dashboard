...
$query="UPDATE plans SET plan_amount='$plan_amount',plan_mode='$plan_mode',plan_details='$plan_details',maturityperiod='$maturity' WHERE id='$upd_id'";
$result_query=mysqli_query($conn,$query);

if($result_query){

    $msg="<div class='alert alert-success'>
  <strong>Success!</strong> Plans Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Plans Is not Update in Database
</div>";
 }
...
$id=$_GET['id'];
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control" name="plan_amount"  value="<?php  echo $row['plan_amount']?>">
    </div>
</div>
<br>
    <div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control" name="plan_mode"  value="<?php  echo $row['plan_mode']?>">
    </div>

    

<div class="col">
        <label>Plan Maturity Period</label>

      <input type="text" class="form-control" name="maturity"  value="<?php  echo $row['maturityperiod']?>">
    </div>
...
<div class="col">
      ...
      <input type="textarea" class="form-control" name="plan_details"  value="<?php  echo $row['plan_details']?>">
    </div>
