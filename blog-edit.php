...
$blog_long=$_POST['long_description'];
$blog_short=$_POST['short_description'];
if($img!="")
{
...
$query="UPDATE blog SET blog_title='$blog_title',blog_long_discript='$blog_long',blog_short_discript='$blog_short',blog_image='$target_file' WHERE ID='$upd_id'";

}
else{
$query="UPDATE blog SET blog_title='$blog_title',blog_long_discript='$blog_long',blog_short_discript='$blog_short' WHERE ID='$upd_id'";
...
if($result_query){
  ...
  <strong>Success!</strong> Blogs Session Updated Done Succesfully.
</div>";
    //header("Location:update-cat.php");
}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Soory Blogs Session Is not Update in Database
</div>";
 }
}
?>
            ...
            <div class="row g-0">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-30">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Edit Video Session</h1>
                    </div>
                </div>
                <!-- Title End -->
...
$id=$_GET['id'];
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <input type="text" class="form-control" name="title"  value="<?php  echo $row['blog_title']?>">
    </div>
</div>
<br>
    <div class="row">
    <div class="col">
      ...
      <input type="textarea" class="form-control" name="long_description" value="<?php  echo $row['blog_long_discript']?>">
    </div>
    <div class="col">
        <label>Blog Short Description</label>

      <input type="text" class="form-control" name="short_description" value="<?php  echo $row['blog_short_discript']?>">
    </div>
...
<div class="row">
        <div class="col text-center">
            <img src="<?php echo $row['blog_image']; ?> " width=600 height=400>
    </div>
</div>
<br>
<br>
        ...
        <div class="modal modal-right fade" id="discountAddModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="post-form" action="addblog.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label">blog_title</label>
                                <input type="text" name="blog_title" class="form-control mask-text"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">blog_long_discript</label>
                                <input type="text" name="blog_long_discript" class="form-control mask-text"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">blog_short_discript</label>
                                <input type="text" name="blog_short_discript" class="form-control mask-text"/>
                            </div>
                            <div class="mb-3 w-100">
